...
export function TreeView<TData>({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "flex flex-1 w-full overflow-y-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-gray-600 focus-within:outline-none",
        parentClassName
      )}
      layoutScroll
      {...getTreeProps()}
