...
//     endOfMonthISO: endOfMonth(todayValue).toDate(localTimeZone).toISOString(),
//     startOfYearISO: startOfYear(todayValue).toDate(localTimeZone).toISOString(),
//     weekAgoISO: todayValue.subtract({ days: 7 }).toDate(localTimeZone).toISOString(),
